...
class genderDetection():
    ...
    def getStasticsData(self):
        ...
        # collection = db.userFollStastics_med
        # data = collection.find({},).batch_size(1000)
        # count = 0
        # self.stasticsData = []
        # stasticsUID = []
        # for line in data:
        ...
        #     wcpMap = {'uid': uid, **wcpMapTemp,'gender': line['gender'],
        ...
        # droppList = []
        # droppList = [ '_id','HPLevel',
        #              'communityRPScore',
        #              'onlineTime']
        # data = data.drop(droppList, axis=1)
